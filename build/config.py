"""Dados do WebLab: trilhas, aulas, unidades, cronograma 2026.2 e avaliações.

Este é o ÚNICO lugar do repositório onde datas do semestre aparecem (além da
Aula 01 de cada nível, que apresenta a disciplina). As aulas em si são
atemporais. Para reutilizar o material em outro semestre, troque só o
CRONOGRAMA e AVALIACOES.

Fonte das datas: Planos de Curso 2026.2 (docs/planos/*.pdf). Para o Nível 3,
as datas seguem a correção feita pelo professor no material publicado
(aulas às quartas-feiras: +2 dias em relação ao PDF do plano).
"""
...
# --------------------------------------------------------------------------
# Cronograma 2026.2 (datas literais do Plano de Curso; N3 com a correção +2 dias)
# --------------------------------------------------------------------------
CRONOGRAMA = {
    "nivel-1": [
