...
> **📌 Na prova**
> Qualquer projeto desta página pode ser o seu projeto autoral das avaliações, desde que o professor aprove a escolha antes do início da unidade e que ele siga a mesma arquitetura do projeto fio-condutor da trilha (Nível 1: site estático de várias páginas; Nível 2: SPA com API Express e login; Nível 3: Vue, Pinia, Express, banco e Firebase). Na rubrica sugerida para os projetos integradores, estrutura HTML e CSS com responsividade pesam 20 % cada, JavaScript 30 %, regras e validações 15 %, usabilidade 10 % e apresentação (demonstração e explicação das decisões) 5 %. A rubrica de cada avaliação, publicada na última aula da unidade, é a que vale para a nota.
