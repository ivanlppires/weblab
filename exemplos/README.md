...
Código de aula executável: projetos e demos que materializam as aulas da apostila,
para o professor rodar e projetar em sala.

Isto **não** entra no build do site (`build/build.py` só lê `fontes/`). São arquivos
para abrir no navegador, não fonte de conteúdo.
